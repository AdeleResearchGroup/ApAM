package fr.imag.adele.apam.app.calme;
...
public class CalManager implements CalendarManager {

	  /**
	   * Be sure to specify the name of your application. If the application name is {@code null} or
	   * blank, the application will log a warning. Suggested format is "MyCompany-ProductName/1.0".
	   */
	  private static final String APPLICATION_NAME = "calendar coat";
	  ...
	  public void start(){
		  System.out.println("starting calendar manager!");
		  new CalManager().main(new String[]{});
		  
	  }
	  
	  public void stop(){
		  System.out.println("stopping calendar manager!");
	  }
...
//	        deleteCalendar(calendar);
	...
	@Override
	public List<fr.imag.adele.apam.app.calme.api.ApamCalendar> getCalendars() {

		try {
			return adaptCalendarList(client.calendarList().list().execute());
		} catch (IOException e) {
	...
	private List<fr.imag.adele.apam.app.calme.api.ApamCalendar> adaptCalendarList(CalendarList calendargoogle){
		ArrayList<fr.imag.adele.apam.app.calme.api.ApamCalendar> calendars=new ArrayList<fr.imag.adele.apam.app.calme.api.ApamCalendar>();
		
		for(CalendarListEntry calendarListEntryGoogle:calendargoogle.getItems()){
			calendars.add(new fr.imag.adele.apam.app.calme.api.ApamCalendar(calendarListEntryGoogle.getId(),calendarListEntryGoogle.getSummary()));
		}
