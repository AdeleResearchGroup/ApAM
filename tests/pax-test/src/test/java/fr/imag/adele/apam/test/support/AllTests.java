...
@SuiteClasses({ CompositeTest.class, ConstraintTest.class,
		InjectionInstantiationTest.class, PropertyTest.class,DynamanDependentTest.class, OBRMANTest.class, MessageTest.class, MetaSubstitutionTest.class, RelationTest.class})
