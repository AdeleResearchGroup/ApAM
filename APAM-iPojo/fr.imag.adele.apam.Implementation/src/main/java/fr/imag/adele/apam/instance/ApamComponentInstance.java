...
public class ApamComponentInstance extends InstanceManager implements ApformInstance {
     ...
     * @param handlers
     */
    public ApamComponentInstance(ApamFactory implementation, boolean isApamCreated, BundleContext context,
    ...
    public boolean substWire(Instance oldDestInst, Instance newDestInst, String depName) {
        System.out.println("Native instance subs wire " + depName + " :" + getInstanceName() + "from ->" + oldDestInst
                + " to ->" + newDestInst);
        Dependency dependency = dependencies.get(depName);
