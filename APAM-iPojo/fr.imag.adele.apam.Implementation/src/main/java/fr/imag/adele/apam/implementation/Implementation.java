...
public class Implementation extends ComponentFactory {
    ...
    public static class Description extends ComponentTypeDescription {
        ...
        public Element getDescription() {
            ...
            if (getSpecification() != null)
                description
                        .addAttribute(new Attribute(Implementation.COMPONENT_SPECIFICATION_PROPERTY, getSpecification()));

            for (DependencyModel dependency : getDependencies()) {
                Element dependencyDescription = new Element(Implementation.DEPENDENCY_DECLARATION,
                        Implementation.APAM_NAMESPACE);
    ...
    public void check(Element element) throws ConfigurationException {
        ...
        m_specification = element.getAttribute(Implementation.COMPONENT_SPECIFICATION_PROPERTY);
