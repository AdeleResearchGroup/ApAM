...
public class OBRManager {
	 ...
	 * @param searchLocalRepo if true Search for the local repository from M2_HOME and USER_HOME
	 */
	private void initCommonRepositories(boolean searchLocalRepo, RepositoryAdmin repoAdmin) {
		try {
			...
			CompositeRepostiory rootComposite = new CompositeRepostiory(repoAdmin);
			compositeRepositories.put(CST.ROOTCOMPOSITETYPE,rootComposite);
...
//	private Set<Selected> lookForAll(CompositeType compoType, String capability, String filterStr,
//			Set<Filter> constraints) {
//		Set<Selected> allRes = new HashSet<Selected>();
//		System.out.print("looking for all resources : " + capability
//				+ "; filter : " + filterStr);
...
//					if (aCap.getName().equals(capability)) {
//						if ((filter == null)
//								|| filter.matchCase(aCap.getPropertiesAsMap())) {
//							if ((constraints == null)
//									|| matchConstraints(aCap, constraints)) {
//								System.out.print("   Found bundle : "
//										+ res.getSymbolicName()
//										+ " Component:  ");
//								if (aCap.getName().equals(
//										OBR.CAPABILITY_SPECIFICATION)) {
//									System.out
//											.println(getAttributeInCapability(
//													aCap, CST.A_SPECNAME));
//								} else if (aCap.getName().equals(
//										OBR.CAPABILITY_IMPLEMENTATION)) {
//									System.out
//											.println(getAttributeInCapability(
//													aCap, CST.A_IMPLNAME));
//								}
...
//	}
	 ...
	 */
//	public Selected lookFor(String capability, String filterStr,
//			Set<Filter> constraints, List<Filter> preferences) {
//		if ((preferences != null) && !preferences.isEmpty()) {
//			return lookForPref(capability, preferences,
//					lookForAll(capability, filterStr, constraints));
//		}
//		return lookFor(capability, filterStr, constraints);
//	}

	public Selected lookFor(CompositeType compoType, String capability, String filterStr,
			Set<Filter> constraints, Object object) {
		...
		System.out.println("");
		CompositeRepostiory compositeRepostiory = compositeRepositories.get(compoType.getName());

		// Requirement req = repoAdmin.getHelper().requirement(capability,
		// filterStr);
	...
	public void newModel(String obrModel, String composite) {
		...
		CompositeRepostiory compositeRepository = new CompositeRepostiory(repoAdmin);
	...
	public class Selected {
		...
		public Selected(CompositeRepostiory compoRepo, Resource res, Capability cap) {
			resource = res;
			capability = cap;
