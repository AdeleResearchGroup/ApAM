...
//import fr.imag.adele.am.exception.ConnectionException;
	...
	public interface Attributes {
	    ...
	    /**
	     * The method asks the attribute managers to verify if that (attribute/value) pair is legal (type checking ...).
	     * If legal,the attributes/value is added to the associated instance, and also changed in the SAM associated instance. 
	     * if not the change is ignored. 
	     * WARNING : if SAM cannot set that attribute in the real instance, the Apam attribute and the real instance property
	    ...
	    /**
	     * Same as previous method, but if the manager is registered, the changes are accepted without check, and sent to SAM.
	     * @param manager
	     * @param key
	     * @param value
	     */
