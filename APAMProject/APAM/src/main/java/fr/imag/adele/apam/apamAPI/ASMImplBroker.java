...
public interface ASMImplBroker {
  ...
  /**
     ...
     * For those implementation with no logical name, looks for the SAM name.
    ...
    /**
     * Returns the ASM implementation with the given sam name. 
     * WARNING : that implementation may be present in SAM but not in ASM, in which case return null.
