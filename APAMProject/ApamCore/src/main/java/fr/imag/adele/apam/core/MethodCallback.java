...
public class MethodCallback {
	...
	protected MethodCallback(JavaImplementationDeclaration implementation,
	...
	public static class PushConsumer extends MethodCallback {
		...
		protected PushConsumer(JavaImplementationDeclaration implementation, String methodName, DependencyDeclaration dependency, MessageReference resource) {
