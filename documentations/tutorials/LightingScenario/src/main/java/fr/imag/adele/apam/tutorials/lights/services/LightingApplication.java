...
public class LightingApplication {
    ...
    public void newButton() {
    	System.out.println("LightingApplication: "+myName+".newButton() : "+theButtons.size()+" buttons in the list");    	        
    }
    public void removeButton() {
    	System.out.println("LightingApplication: "+myName+".removeButton() : "+theButtons.size()+" buttons in the list");    	        
    }
