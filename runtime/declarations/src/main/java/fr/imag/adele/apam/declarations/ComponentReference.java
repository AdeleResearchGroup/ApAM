...
/**
 * This class represent references to APAM components. They are parameterized by
 * the type of component declaration so that they can be statically typed.
 * 
 * Notice that a component reference can in turn be used as namespace for
 * referencing entities locally declared in the scope of the component
 * declaration;
 * 
 * @author vega
 * 
