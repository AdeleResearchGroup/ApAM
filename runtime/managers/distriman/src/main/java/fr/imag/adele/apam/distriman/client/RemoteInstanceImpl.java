...
public class RemoteInstanceImpl implements ApformInstance {
    ...
    public RemoteInstanceImpl(String dependencyId, String url,
	    Composite composite, Object serviceObject) {
	...
	// throw new
	// UnsupportedOperationException("impossible to change remote instance properties");
    }
