...
/**
 * ApformCompositeType of and the factory of RemoteMachine. Instance of this
...
public class ApamMachineFactoryImpl implements ApamMachineFactory, ApformCompositeType {
    ...
    static Logger logger = LoggerFactory
	    .getLogger(ApamMachineFactoryImpl.class);
	...
	throw new UnsupportedOperationException(
		"ApformCompositeType can not be discovered");
    }

    @Override
    public RemoteMachine createInstance(Map<String, String> initialproperties)
	    throws ComponentImpl.InvalidConfiguration {
	throw new UnsupportedOperationException(
		"ApformCompositeType is not instantiable");
    }
    ...
    /**
     * Destroy the RemoteMachine of given url, created through this
     ...
     * @param url
     *            The RemoteMachine url
     * @return The RemoteMachine representing the machine of given
     *         <code>url</code>
     */
	...
	// TODO distriman: implement set property for distriman representation
	// in apam?
    }
