...
public interface RelationManager extends Manager{
	 ...
	 */
	public Instance resolveImpl(Component client, Implementation impl, Relation relation);
	 ...
	 */
	public Set<Instance> resolveImpls(Component client, Implementation impl, Relation relation);
