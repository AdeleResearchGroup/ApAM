...
public class CST {
    ...
    // OBR.
    public static final String[] reservedPrefix = { CST.APAM_PREFIX,
	    CST.DEFINITION_PREFIX, CST.PROVIDE_PREFIX, CST.REQUIRE_PREFIX };
    ...
    public static final String[] finalAttributes = { CST.NAME, VERSION,
	    CST.SPECNAME, CST.IMPLNAME, CST.INSTNAME, CST.MESSAGE,
	    CST.APAM_COMPOSITE, CST.APAM_COMPOSITETYPE,
	    CST.APAM_MAIN_COMPONENT, CST.APAM_MAIN_INSTANCE, CST.INTERFACE,
	    CST.REQUIRE_INTERFACE, CST.REQUIRE_SPECIFICATION,
	    CST.REQUIRE_MESSAGE, CST.PROVIDE_INTERFACES, CST.PROVIDE_MESSAGES,
	    CST.PROVIDE_SPECIFICATION, CST.INSTANTIABLE, CST.MULTIPLE,
	    CST.REMOTABLE, CST.SHARED, CST.SINGLETON };
    ...
    public static final String[] finalRelations = { REL_CONTAINS,
	    REL_COMPOSITE, REL_APPLI, REL_COMPOTYPE, REL_SPEC, REL_IMPL,
	    REL_INST, REL_IMPLS, REL_INSTS };
