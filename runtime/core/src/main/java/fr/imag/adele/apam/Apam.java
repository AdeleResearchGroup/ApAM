...
public interface Apam {
	...
	/**
	 * The property used to specify the managers that must be wi in the system.
	 *
	 */
     ...
     *
     */
    public static final String CONFIGURATION_MANAGERS = "fr.imag.adele.apam.managers.configuration";
	 ...
	 * 
	 * @param inCompoType
	 *            : name of the father composite type. Null if root
	 *            (application).
	 * @param name
	 *            : the symbolic name. Unique.
	 * @param mainImplem
	 *            : The name of the main implementation or a specification name.
	 *            If not found, returns null.
	 * @param models
	 *            optional : the associated models.
	 * @param attributes
	 *            optional : the initial properties to associate with this
	 *            composite type (as an implementation). @ return : the created
	 *            composite type
	 */
	CompositeType createCompositeType(String inCompoType, String name, String specName, String mainImplSpecName, Set<ManagerModel> models, Map<String, String> attributes);
	...
	/**
	 * 
	 * @return all the root composite types (embedded in the system root
	 *         composite type)
	 */
	Collection<CompositeType> getRootCompositeTypes();

	/**
	 * Simply creates an instance of the composite type. It starts either
	 * because it implements the ApamComponnent interface, of calling its
	 * getServiceObject method.
	 */
	Composite startAppli(CompositeType compositeType);

	/**
	 * Resolve compositeTypeName and, if successful, creates an instance of that
	 * type. It starts either because it implements the ApamComponent interface,
	 * of calling its getServiceObject method.
	 */
	Composite startAppli(String compositeTypeName);

	/**
	 * deploys the bundle found at the provided URL. Looks in that bundle for a
	 * composite type with name "compositeTypeName". If found creates that
	 * composite type and creates an instance of that type. It starts either
	 * because it implements the ApamComponnent interface, of calling its
	 * getServiceObject method.
	 */
