...
public class AttrType {
	 ...
	 * "a, b, c, ...", or "int", "integer", "string", "boolean"
	 */
	...
	if (typeString.equalsIgnoreCase("int")
		|| typeString.equalsIgnoreCase("integer")) {
	    type = INTEGER;
	    return;
	}
	...
	logger.error("Invalid type " + typeString
		+ ". Expected enumeration, string, integer, boolean.");
    }
